...
<div class="container">
    ...
    <a href="add-income.php" class="btn btn-info btn-sm mb-3" role="button" aria-pressed="true">Add New Income </a>

    <!-- Income DataTable -->
    <div class="card mx-auto mb-4 border-info">
        <div class="card-header bg-secondary text-white">Income Table</div>
        <div class="card-body">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Pain</label>
